...
public class UserController {
	...
	@ApiResponses(value = { @ApiResponse(code = 400, message = "Invalid user supplied", responseHeaders = {
			@ResponseHeader(name = "X-Rate-Limit-Limit", description = "The number of allowed requests in the current period"),
			@ResponseHeader(name = "X-Rate-Limit-Remaining", description = "The number of remaining requests in the current period") }),
			@ApiResponse(code = 404, message = "User not found", responseHeaders = {
					@ResponseHeader(name = "X-Rate-Limit-Limit", description = "The number of allowed requests in the current period"),
					@ResponseHeader(name = "X-Rate-Limit-Remaining", description = "The number of remaining requests in the current period") }) })
